...
1. Download here: https://ipl-mini-peds.tebex.io/

2. Make a new folder in your resource folder named [mini-peds]

3. Add `ensure [mini-peds]` to your `server.cfg` file.

4. Restart your FiveM server.

5. Have fun with your new Mini Peds!
